...
from atlassian_jira_python_sdk.pydantic.notification_scheme_and_project_mapping_json_bean import NotificationSchemeAndProjectMappingJsonBean
...
class PageBeanNotificationSchemeAndProjectMappingJsonBean(BaseModel):
    ...
    # The list of items.
    values: typing.Optional[typing.List[NotificationSchemeAndProjectMappingJsonBean]] = Field(None, alias='values')
