...
from atlassian_jira_python_sdk.pydantic.field_configuration_scheme_projects import FieldConfigurationSchemeProjects
...
class PageBeanFieldConfigurationSchemeProjects(BaseModel):
    ...
    # The list of items.
    values: typing.Optional[typing.List[FieldConfigurationSchemeProjects]] = Field(None, alias='values')
