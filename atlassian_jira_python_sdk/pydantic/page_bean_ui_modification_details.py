...
from atlassian_jira_python_sdk.pydantic.ui_modification_details import UiModificationDetails
...
class PageBeanUiModificationDetails(BaseModel):
    ...
    # The list of items.
    values: typing.Optional[typing.List[UiModificationDetails]] = Field(None, alias='values')
