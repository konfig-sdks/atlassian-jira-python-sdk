...
from atlassian_jira_python_sdk.pydantic.page_bean_string_values import PageBeanStringValues
...
class PageBeanString(BaseModel):
    ...
    values: typing.Optional[PageBeanStringValues] = Field(None, alias='values')
