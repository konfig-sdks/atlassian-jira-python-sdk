...
class ConditionGroupConfiguration(BaseModel):
    ...
    condition_groups: typing.Optional['typing.List["ConditionGroupConfiguration"]'] = Field(None, alias='conditionGroups')
    ...
    operation: typing.Optional[Literal["ANY", "ALL"]] = Field(None, alias='operation')
