...
from atlassian_jira_python_sdk.pydantic.field_configuration_details import FieldConfigurationDetails
...
class PageBeanFieldConfigurationDetails(BaseModel):
    ...
    # The list of items.
    values: typing.Optional[typing.List[FieldConfigurationDetails]] = Field(None, alias='values')
