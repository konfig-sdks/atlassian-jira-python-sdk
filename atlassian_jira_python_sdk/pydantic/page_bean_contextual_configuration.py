...
from atlassian_jira_python_sdk.pydantic.contextual_configuration import ContextualConfiguration
...
class PageBeanContextualConfiguration(BaseModel):
    ...
    # The list of items.
    values: typing.Optional[typing.List[ContextualConfiguration]] = Field(None, alias='values')
