...
from atlassian_jira_python_sdk.pydantic.custom_field_value_update_issue_ids import CustomFieldValueUpdateIssueIds

class CustomFieldValueUpdate(BaseModel):
    issue_ids: CustomFieldValueUpdateIssueIds = Field(alias='issueIds')
