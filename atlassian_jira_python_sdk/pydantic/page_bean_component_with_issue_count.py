...
from atlassian_jira_python_sdk.pydantic.component_with_issue_count import ComponentWithIssueCount
...
class PageBeanComponentWithIssueCount(BaseModel):
    ...
    # The list of items.
    values: typing.Optional[typing.List[ComponentWithIssueCount]] = Field(None, alias='values')
