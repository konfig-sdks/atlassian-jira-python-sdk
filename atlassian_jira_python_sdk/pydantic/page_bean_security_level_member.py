...
from atlassian_jira_python_sdk.pydantic.security_level_member import SecurityLevelMember
...
class PageBeanSecurityLevelMember(BaseModel):
    ...
    # The list of items.
    values: typing.Optional[typing.List[SecurityLevelMember]] = Field(None, alias='values')
