...
from atlassian_jira_python_sdk.pydantic.issue_type_screen_scheme_item import IssueTypeScreenSchemeItem
...
class PageBeanIssueTypeScreenSchemeItem(BaseModel):
    ...
    # The list of items.
    values: typing.Optional[typing.List[IssueTypeScreenSchemeItem]] = Field(None, alias='values')
