...
from atlassian_jira_python_sdk.pydantic.notification_scheme import NotificationScheme
...
class PageBeanNotificationScheme(BaseModel):
    ...
    # The list of items.
    values: typing.Optional[typing.List[NotificationScheme]] = Field(None, alias='values')
