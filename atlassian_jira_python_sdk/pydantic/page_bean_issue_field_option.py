...
from atlassian_jira_python_sdk.pydantic.issue_field_option import IssueFieldOption
...
class PageBeanIssueFieldOption(BaseModel):
    ...
    # The list of items.
    values: typing.Optional[typing.List[IssueFieldOption]] = Field(None, alias='values')
