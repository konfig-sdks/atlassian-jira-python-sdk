...
from atlassian_jira_python_sdk.pydantic.issue_type_scheme_projects import IssueTypeSchemeProjects
...
class PageBeanIssueTypeSchemeProjects(BaseModel):
    ...
    # The list of items.
    values: typing.Optional[typing.List[IssueTypeSchemeProjects]] = Field(None, alias='values')
