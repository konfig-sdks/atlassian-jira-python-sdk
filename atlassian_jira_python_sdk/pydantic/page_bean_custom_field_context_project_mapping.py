...
from atlassian_jira_python_sdk.pydantic.custom_field_context_project_mapping import CustomFieldContextProjectMapping
...
class PageBeanCustomFieldContextProjectMapping(BaseModel):
    ...
    # The list of items.
    values: typing.Optional[typing.List[CustomFieldContextProjectMapping]] = Field(None, alias='values')
