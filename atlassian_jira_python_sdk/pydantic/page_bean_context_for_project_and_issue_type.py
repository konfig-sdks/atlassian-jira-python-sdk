...
from atlassian_jira_python_sdk.pydantic.context_for_project_and_issue_type import ContextForProjectAndIssueType
...
class PageBeanContextForProjectAndIssueType(BaseModel):
    ...
    # The list of items.
    values: typing.Optional[typing.List[ContextForProjectAndIssueType]] = Field(None, alias='values')
