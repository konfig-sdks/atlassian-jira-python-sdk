...
from atlassian_jira_python_sdk.pydantic.resolution_json_bean import ResolutionJsonBean
...
class PageBeanResolutionJsonBean(BaseModel):
    ...
    # The list of items.
    values: typing.Optional[typing.List[ResolutionJsonBean]] = Field(None, alias='values')
