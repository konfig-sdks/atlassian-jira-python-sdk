...
from atlassian_jira_python_sdk.pydantic.component_json_bean import ComponentJsonBean
...
class PageBean2ComponentJsonBean(BaseModel):
    ...
    # The list of items.
    values: typing.Optional[typing.List[ComponentJsonBean]] = Field(None, alias='values')
