...
from atlassian_jira_python_sdk.pydantic.security_scheme_with_projects import SecuritySchemeWithProjects
...
class PageBeanSecuritySchemeWithProjects(BaseModel):
    ...
    # The list of items.
    values: typing.Optional[typing.List[SecuritySchemeWithProjects]] = Field(None, alias='values')
