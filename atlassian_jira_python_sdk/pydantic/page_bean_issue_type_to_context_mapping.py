...
from atlassian_jira_python_sdk.pydantic.issue_type_to_context_mapping import IssueTypeToContextMapping
...
class PageBeanIssueTypeToContextMapping(BaseModel):
    ...
    # The list of items.
    values: typing.Optional[typing.List[IssueTypeToContextMapping]] = Field(None, alias='values')
