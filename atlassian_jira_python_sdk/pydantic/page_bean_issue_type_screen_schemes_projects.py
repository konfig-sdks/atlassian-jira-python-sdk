...
from atlassian_jira_python_sdk.pydantic.issue_type_screen_schemes_projects import IssueTypeScreenSchemesProjects
...
class PageBeanIssueTypeScreenSchemesProjects(BaseModel):
    ...
    # The list of items.
    values: typing.Optional[typing.List[IssueTypeScreenSchemesProjects]] = Field(None, alias='values')
