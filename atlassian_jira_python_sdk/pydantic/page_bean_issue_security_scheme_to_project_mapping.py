...
from atlassian_jira_python_sdk.pydantic.issue_security_scheme_to_project_mapping import IssueSecuritySchemeToProjectMapping
...
class PageBeanIssueSecuritySchemeToProjectMapping(BaseModel):
    ...
    # The list of items.
    values: typing.Optional[typing.List[IssueSecuritySchemeToProjectMapping]] = Field(None, alias='values')
