...
from atlassian_jira_python_sdk.pydantic.custom_field_context import CustomFieldContext
...
class PageBeanCustomFieldContext(BaseModel):
    ...
    # The list of items.
    values: typing.Optional[typing.List[CustomFieldContext]] = Field(None, alias='values')
