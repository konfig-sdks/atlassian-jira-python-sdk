...
from atlassian_jira_python_sdk.pydantic.jira_expression_complexity_variables import JiraExpressionComplexityVariables
...
class JiraExpressionComplexity(BaseModel):
    ...
    variables: typing.Optional[JiraExpressionComplexityVariables] = Field(None, alias='variables')
