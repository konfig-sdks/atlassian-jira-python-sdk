...
from atlassian_jira_python_sdk.pydantic.issue_type_scheme_mapping import IssueTypeSchemeMapping
...
class PageBeanIssueTypeSchemeMapping(BaseModel):
    ...
    # The list of items.
    values: typing.Optional[typing.List[IssueTypeSchemeMapping]] = Field(None, alias='values')
