...
class SharePermissionInputBean(BaseModel):
    ...
    type: Literal["user", "project", "group", "projectRole", "global", "authenticated"] = Field(alias='type')
    ...
    project_role_id: typing.Optional[str] = Field(None, alias='projectRoleId')

    # The rights for the share permission.
    rights: typing.Optional[int] = Field(None, alias='rights')
