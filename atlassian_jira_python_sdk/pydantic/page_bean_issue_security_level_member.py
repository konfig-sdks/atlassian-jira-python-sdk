...
from atlassian_jira_python_sdk.pydantic.issue_security_level_member import IssueSecurityLevelMember
...
class PageBeanIssueSecurityLevelMember(BaseModel):
    ...
    # The list of items.
    values: typing.Optional[typing.List[IssueSecurityLevelMember]] = Field(None, alias='values')
