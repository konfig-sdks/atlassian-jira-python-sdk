...
from atlassian_jira_python_sdk.exceptions_base import ApiValueError
from atlassian_jira_python_sdk.exceptions import ClientConfigurationError
from atlassian_jira_python_sdk.exceptions import InvalidHostConfigurationError
...
conf = atlassian_jira_python_sdk.Configuration(
    username='the-user',
    ...
    def __init__(self, host=None,
        ...
        """Constructor
        """
        self.host = "https://your-domain.atlassian.net" if host is None else host
        """Default Base url
        """
        ...
        """Logging Settings
        """
        self.logger = logging.getLogger("atlassian_jira_python_sdk")
    ...
    def to_debug_report(self):
        ...
        return "Python SDK Debug Report:\n"\
               ...
               "Version of the API: 1001.0.0-SNAPSHOT-9aad01a33a3dae75a5b6aedf98c77d2cbd2f865d\n"\
               "SDK Package Version: 1001.0.0-SNAPSHOT-9aad01a33a3dae75a5b6aedf98c77d2cbd2f865d".\
...
class OAuth:
    def __init__(self, client_id: typing.AnyStr, client_secret: typing.AnyStr, token_url: str = "https://auth.atlassian.com/oauth/token") -> None:
