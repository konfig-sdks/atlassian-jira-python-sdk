...
class RequiredPermissionDetails(TypedDict):
...
class OptionalPermissionDetails(TypedDict, total=False):
    pass

class PermissionDetails(RequiredPermissionDetails, OptionalPermissionDetails):
    pass
