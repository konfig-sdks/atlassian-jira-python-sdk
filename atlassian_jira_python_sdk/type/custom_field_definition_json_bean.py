...
class RequiredCustomFieldDefinitionJsonBean(TypedDict):
...
class OptionalCustomFieldDefinitionJsonBean(TypedDict, total=False):
...
class CustomFieldDefinitionJsonBean(RequiredCustomFieldDefinitionJsonBean, OptionalCustomFieldDefinitionJsonBean):
    pass
