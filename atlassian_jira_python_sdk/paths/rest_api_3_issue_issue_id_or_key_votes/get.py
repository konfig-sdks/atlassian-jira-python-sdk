...
from atlassian_jira_python_sdk.model.votes import Votes as VotesSchema

from atlassian_jira_python_sdk.type.votes import Votes

from ...api_client import Dictionary
from atlassian_jira_python_sdk.pydantic.votes import Votes as VotesPydantic
...
SchemaFor200ResponseBodyApplicationJson = VotesSchema
...
class GetDetails(BaseApi):
    ...
    async def aget_details(
        ...
        **kwargs,
        ...
        if validate:
            return VotesPydantic(**raw_response.body)
        return api_client.construct_model_instance(VotesPydantic, raw_response.body)
