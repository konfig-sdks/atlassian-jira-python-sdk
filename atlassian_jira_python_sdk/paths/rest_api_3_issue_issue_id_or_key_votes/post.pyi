...
class BaseApi(api_client.Api):
    ...
    def _add_user_vote_mapped_args(
        self,
        issue_id_or_key: str,
    ...
    async def _aadd_user_vote_oapg(
        self,
...
class AddUserVoteRaw(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    async def aadd_user_vote(
        self,
        issue_id_or_key: str,
        **kwargs,
    ) -> typing.Union[
        ...
        args = self._add_user_vote_mapped_args(
            issue_id_or_key=issue_id_or_key,
        )
        return await self._aadd_user_vote_oapg(
    ...
    def add_user_vote(
        ...
        return self._add_user_vote_oapg(
            path_params=args.path,
        )

class AddUserVote(BaseApi):
    ...
    async def aadd_user_vote(
        ...
        **kwargs,
        ...
        raw_response = await self.raw.aadd_user_vote(
            issue_id_or_key=issue_id_or_key,
            **kwargs,
        )
        if validate:
    ...
    def add_user_vote(
        ...
        raw_response = self.raw.add_user_vote(
            issue_id_or_key=issue_id_or_key,
        )
        if validate:
            return Dictionary(**raw_response.body)
