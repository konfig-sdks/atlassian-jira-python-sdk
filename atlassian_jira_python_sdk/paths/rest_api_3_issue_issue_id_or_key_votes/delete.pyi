...
class BaseApi(api_client.Api):
    ...
    def _delete_user_vote_mapped_args(
        self,
        issue_id_or_key: str,
    ...
    async def _adelete_user_vote_oapg(
        self,
        ...
        **kwargs,
        ...
        request_before_hook(
            ...
            path_template='/rest/api/3/issue/{issueIdOrKey}/votes',
            auth_settings=_auth,
            headers=_headers,
        )
...
class DeleteUserVoteRaw(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    async def adelete_user_vote(
        self,
        issue_id_or_key: str,
        **kwargs,
    ) -> typing.Union[
        ...
        args = self._delete_user_vote_mapped_args(
            issue_id_or_key=issue_id_or_key,
        )
        return await self._adelete_user_vote_oapg(
            path_params=args.path,
            **kwargs,
        )
    
    def delete_user_vote(
        self,
        issue_id_or_key: str,
    ) -> typing.Union[
        ApiResponseFor204,
        ...
        return self._delete_user_vote_oapg(
            path_params=args.path,
        )

class DeleteUserVote(BaseApi):
    ...
    async def adelete_user_vote(
        ...
        **kwargs,
        ...
        raw_response = await self.raw.adelete_user_vote(
            issue_id_or_key=issue_id_or_key,
            **kwargs,
        )
    ...
    def delete_user_vote(
        ...
        raw_response = self.raw.delete_user_vote(
            issue_id_or_key=issue_id_or_key,
        )
