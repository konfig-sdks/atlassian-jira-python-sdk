...
from atlassian_jira_python_sdk.model.page_bean_workflow_scheme import PageBeanWorkflowScheme as PageBeanWorkflowSchemeSchema

from atlassian_jira_python_sdk.type.page_bean_workflow_scheme import PageBeanWorkflowScheme

from ...api_client import Dictionary
from atlassian_jira_python_sdk.pydantic.page_bean_workflow_scheme import PageBeanWorkflowScheme as PageBeanWorkflowSchemePydantic
...
SchemaFor200ResponseBodyApplicationJson = PageBeanWorkflowSchemeSchema
...
class GetAll(BaseApi):
    ...
    async def aget_all(
        ...
        validate: bool = False,
        **kwargs,
    ) -> PageBeanWorkflowSchemePydantic:
        ...
        if validate:
            return PageBeanWorkflowSchemePydantic(**raw_response.body)
        return api_client.construct_model_instance(PageBeanWorkflowSchemePydantic, raw_response.body)
