...
class BaseApi(api_client.Api):
    ...
    def _delete_custom_field_mapped_args(
        self,
        id: str,
    ...
    async def _adelete_custom_field_oapg(
        self,
...
class DeleteCustomFieldRaw(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    async def adelete_custom_field(
        self,
        id: str,
        **kwargs,
    ) -> typing.Union[
        ...
        args = self._delete_custom_field_mapped_args(
            id=id,
        )
        return await self._adelete_custom_field_oapg(
...
class DeleteCustomField(BaseApi):
    ...
    async def adelete_custom_field(
        ...
        **kwargs,
        ...
        raw_response = await self.raw.adelete_custom_field(
            id=id,
            **kwargs,
        )
    ...
    def delete_custom_field(
        ...
        raw_response = self.raw.delete_custom_field(
            id=id,
        )
