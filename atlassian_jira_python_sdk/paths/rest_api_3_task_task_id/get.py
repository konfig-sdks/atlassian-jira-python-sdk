...
SchemaFor200ResponseBodyApplicationJson = TaskProgressBeanObjectSchema
    ...
    async def _aget_status_oapg(
        ...
        **kwargs,
        ...
        request_before_hook(
            ...
            path_template='/rest/api/3/task/{taskId}',
            auth_settings=_auth,
            headers=_headers,
        )
...
class GetStatus(BaseApi):
    ...
    async def aget_status(
        ...
        validate: bool = False,
        **kwargs,
    ) -> TaskProgressBeanObjectPydantic:
        raw_response = await self.raw.aget_status(
            task_id=task_id,
            **kwargs,
        )
        if validate:
            return TaskProgressBeanObjectPydantic(**raw_response.body)
        return api_client.construct_model_instance(TaskProgressBeanObjectPydantic, raw_response.body)
