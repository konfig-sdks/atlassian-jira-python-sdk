...
from atlassian_jira_python_sdk.model.page_bean_webhook import PageBeanWebhook as PageBeanWebhookSchema

from atlassian_jira_python_sdk.type.page_bean_webhook import PageBeanWebhook
from atlassian_jira_python_sdk.type.error_collection import ErrorCollection

from ...api_client import Dictionary
from atlassian_jira_python_sdk.pydantic.page_bean_webhook import PageBeanWebhook as PageBeanWebhookPydantic
...
SchemaFor200ResponseBodyApplicationJson = PageBeanWebhookSchema
...
class BaseApi(api_client.Api):
    ...
    def _list_dynamic_webhooks_for_app_mapped_args(
        self,
    ...
    async def _alist_dynamic_webhooks_for_app_oapg(
        self,
    ...
    def _list_dynamic_webhooks_for_app_oapg(
        self,
            query_params: typing.Optional[dict] = {},
        skip_deserialization: bool = True,
        timeout: typing.Optional[typing.Union[float, typing.Tuple]] = None,
...
class ListDynamicWebhooksForAppRaw(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    async def alist_dynamic_webhooks_for_app(
        self,
        start_at: typing.Optional[int] = None,
        max_results: typing.Optional[int] = None,
        **kwargs,
        ...
        args = self._list_dynamic_webhooks_for_app_mapped_args(
            start_at=start_at,
            max_results=max_results,
        )
        return await self._alist_dynamic_webhooks_for_app_oapg(
            query_params=args.query,
            **kwargs,
        )
    
    def list_dynamic_webhooks_for_app(
        self,
        start_at: typing.Optional[int] = None,
        max_results: typing.Optional[int] = None,
    ) -> typing.Union[
        ...
        return self._list_dynamic_webhooks_for_app_oapg(
            query_params=args.query,
        )

class ListDynamicWebhooksForApp(BaseApi):
    ...
    async def alist_dynamic_webhooks_for_app(
        ...
        validate: bool = False,
        **kwargs,
    ) -> PageBeanWebhookPydantic:
        raw_response = await self.raw.alist_dynamic_webhooks_for_app(
            start_at=start_at,
            max_results=max_results,
            **kwargs,
        )
        if validate:
            return PageBeanWebhookPydantic(**raw_response.body)
        return api_client.construct_model_instance(PageBeanWebhookPydantic, raw_response.body)
    ...
    def list_dynamic_webhooks_for_app(
        ...
        raw_response = self.raw.list_dynamic_webhooks_for_app(
            start_at=start_at,
            max_results=max_results,
        )
        if validate:
