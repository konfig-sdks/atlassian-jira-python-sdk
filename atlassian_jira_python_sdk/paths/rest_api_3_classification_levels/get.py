...
from atlassian_jira_python_sdk.model.data_classification_levels_bean import DataClassificationLevelsBean as DataClassificationLevelsBeanSchema

from atlassian_jira_python_sdk.type.data_classification_levels_bean import DataClassificationLevelsBean

from ...api_client import Dictionary
from atlassian_jira_python_sdk.pydantic.data_classification_levels_bean import DataClassificationLevelsBean as DataClassificationLevelsBeanPydantic
...
SchemaFor200ResponseBodyApplicationJson = DataClassificationLevelsBeanSchema


@dataclass
class ApiResponseFor200(api_client.ApiResponse):
    body: DataClassificationLevelsBean
    ...
    async def _aget_all_oapg(
        ...
        **kwargs,
        ...
        request_before_hook(
            ...
            path_template='/rest/api/3/classification-levels',
            auth_settings=_auth,
            headers=_headers,
        )
...
class GetAll(BaseApi):
    ...
    async def aget_all(
        ...
        validate: bool = False,
        **kwargs,
    ) -> DataClassificationLevelsBeanPydantic:
        ...
        if validate:
            return DataClassificationLevelsBeanPydantic(**raw_response.body)
        return api_client.construct_model_instance(DataClassificationLevelsBeanPydantic, raw_response.body)
