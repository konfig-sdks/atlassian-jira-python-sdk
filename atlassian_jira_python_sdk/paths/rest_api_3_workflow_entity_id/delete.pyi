...
class BaseApi(api_client.Api):
    ...
    def _delete_inactive_workflow_mapped_args(
        self,
        entity_id: str,
    ...
    async def _adelete_inactive_workflow_oapg(
        self,
        ...
        **kwargs,
        ...
        request_before_hook(
            ...
            path_template='/rest/api/3/workflow/{entityId}',
            auth_settings=_auth,
            headers=_headers,
        )
    ...
    def _delete_inactive_workflow_oapg(
        self,
            path_params: typing.Optional[dict] = {},
        skip_deserialization: bool = True,
        timeout: typing.Optional[typing.Union[float, typing.Tuple]] = None,
...
class DeleteInactiveWorkflowRaw(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    async def adelete_inactive_workflow(
        self,
        entity_id: str,
        **kwargs,
    ) -> typing.Union[
        ...
        args = self._delete_inactive_workflow_mapped_args(
            entity_id=entity_id,
        )
        return await self._adelete_inactive_workflow_oapg(
    ...
    def delete_inactive_workflow(
        ...
        return self._delete_inactive_workflow_oapg(
            path_params=args.path,
        )

class DeleteInactiveWorkflow(BaseApi):
    ...
    async def adelete_inactive_workflow(
        ...
        **kwargs,
        ...
        raw_response = await self.raw.adelete_inactive_workflow(
            entity_id=entity_id,
            **kwargs,
        )
    ...
    def delete_inactive_workflow(
        ...
        raw_response = self.raw.delete_inactive_workflow(
            entity_id=entity_id,
        )
