...
from atlassian_jira_python_sdk.model.page_bean_priority import PageBeanPriority as PageBeanPrioritySchema

from atlassian_jira_python_sdk.type.error_collection import ErrorCollection
from atlassian_jira_python_sdk.type.page_bean_priority import PageBeanPriority

from ...api_client import Dictionary
from atlassian_jira_python_sdk.pydantic.page_bean_priority import PageBeanPriority as PageBeanPriorityPydantic
...
class ProjectIdSchema(
    ...
    def __getitem__(self, i: int) -> MetaOapg.items:
        return super().__getitem__(i)
PriorityNameSchema = schemas.StrSchema
...
RequestOptionalQueryParams = typing_extensions.TypedDict(
    'RequestOptionalQueryParams',
    {
        ...
        'priorityName': typing.Union[PriorityNameSchema, str, ],
...
request_query_priority_name = api_client.QueryParameter(
    name="priorityName",
    style=api_client.ParameterStyle.FORM,
    schema=PriorityNameSchema,
    explode=True,
)
...
SchemaFor200ResponseBodyApplicationJson = PageBeanPrioritySchema
...
class BaseApi(api_client.Api):
    ...
    def _search_mapped_args(
        ...
        if priority_name is not None:
            _query_params["priorityName"] = priority_name
...
class Search(BaseApi):
    ...
    async def asearch(
        ...
        **kwargs,
        ...
        if validate:
            return PageBeanPriorityPydantic(**raw_response.body)
        return api_client.construct_model_instance(PageBeanPriorityPydantic, raw_response.body)
