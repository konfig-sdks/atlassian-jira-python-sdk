...
from atlassian_jira_python_sdk.model.page_bean_issue_type_scheme import PageBeanIssueTypeScheme as PageBeanIssueTypeSchemeSchema

from atlassian_jira_python_sdk.type.page_bean_issue_type_scheme import PageBeanIssueTypeScheme

from ...api_client import Dictionary
from atlassian_jira_python_sdk.pydantic.page_bean_issue_type_scheme import PageBeanIssueTypeScheme as PageBeanIssueTypeSchemePydantic
...
SchemaFor200ResponseBodyApplicationJson = PageBeanIssueTypeSchemeSchema
...
class BaseApi(api_client.Api):
    ...
    def _get_all_schemes_mapped_args(
        self,
    ...
    async def _aget_all_schemes_oapg(
        self,
...
class GetAllSchemesRaw(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    async def aget_all_schemes(
        self,
        start_at: typing.Optional[int] = None,
        max_results: typing.Optional[int] = None,
        id: typing.Optional[typing.List[int]] = None,
        ...
        **kwargs,
        ...
        args = self._get_all_schemes_mapped_args(
            start_at=start_at,
        ...
        return await self._aget_all_schemes_oapg(
    ...
    def get_all_schemes(
        ...
        return self._get_all_schemes_oapg(
            query_params=args.query,
        )

class GetAllSchemes(BaseApi):
    ...
    async def aget_all_schemes(
        ...
        validate: bool = False,
        **kwargs,
    ) -> PageBeanIssueTypeSchemePydantic:
        raw_response = await self.raw.aget_all_schemes(
            start_at=start_at,
            max_results=max_results,
            id=id,
            order_by=order_by,
        ...
        if validate:
            return PageBeanIssueTypeSchemePydantic(**raw_response.body)
        return api_client.construct_model_instance(PageBeanIssueTypeSchemePydantic, raw_response.body)
    ...
    def get_all_schemes(
        ...
        raw_response = self.raw.get_all_schemes(
            start_at=start_at,
            max_results=max_results,
            id=id,
            order_by=order_by,
