...
class BaseApi(api_client.Api):
    ...
    def _get_avatar_image_by_owner_mapped_args(
        self,
        type: str,
        entity_id: str,
    ...
    async def _aget_avatar_image_by_owner_oapg(
        self,
        ...
        **kwargs,
        ...
        request_before_hook(
            ...
            path_template='/rest/api/3/universal_avatar/view/type/{type}/owner/{entityId}',
            auth_settings=_auth,
            headers=_headers,
        )
    ...
    def _get_avatar_image_by_owner_oapg(
        self,
            query_params: typing.Optional[dict] = {},
            path_params: typing.Optional[dict] = {},
        skip_deserialization: bool = True,
...
class GetAvatarImageByOwnerRaw(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    async def aget_avatar_image_by_owner(
        self,
        type: str,
        entity_id: str,
        size: typing.Optional[str] = None,
        ...
        **kwargs,
        ...
        args = self._get_avatar_image_by_owner_mapped_args(
            type=type,
            entity_id=entity_id,
            size=size,
            format=format,
        )
        return await self._aget_avatar_image_by_owner_oapg(
    ...
    def get_avatar_image_by_owner(
        ...
        return self._get_avatar_image_by_owner_oapg(
            query_params=args.query,
            path_params=args.path,
        )

class GetAvatarImageByOwner(BaseApi):
    ...
    async def aget_avatar_image_by_owner(
        ...
        **kwargs,
        ...
        raw_response = await self.raw.aget_avatar_image_by_owner(
            type=type,
            entity_id=entity_id,
            size=size,
            format=format,
    ...
    def get_avatar_image_by_owner(
        ...
        raw_response = self.raw.get_avatar_image_by_owner(
            type=type,
            entity_id=entity_id,
            size=size,
            format=format,
