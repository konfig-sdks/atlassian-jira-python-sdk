...
class BaseApi(api_client.Api):
    ...
    def _delete_security_scheme_mapped_args(
        self,
        scheme_id: str,
    ...
    async def _adelete_security_scheme_oapg(
        self,
        ...
        **kwargs,
        ...
        request_before_hook(
            ...
            path_template='/rest/api/3/issuesecurityschemes/{schemeId}',
            auth_settings=_auth,
            headers=_headers,
        )
    ...
    def _delete_security_scheme_oapg(
        self,
            path_params: typing.Optional[dict] = {},
        skip_deserialization: bool = True,
        timeout: typing.Optional[typing.Union[float, typing.Tuple]] = None,
...
class DeleteSecuritySchemeRaw(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    async def adelete_security_scheme(
        self,
        scheme_id: str,
        **kwargs,
    ) -> typing.Union[
        ...
        args = self._delete_security_scheme_mapped_args(
            scheme_id=scheme_id,
        )
        return await self._adelete_security_scheme_oapg(
    ...
    def delete_security_scheme(
        ...
        return self._delete_security_scheme_oapg(
            path_params=args.path,
        )

class DeleteSecurityScheme(BaseApi):
    ...
    async def adelete_security_scheme(
        ...
        **kwargs,
        ...
        raw_response = await self.raw.adelete_security_scheme(
            scheme_id=scheme_id,
            **kwargs,
        )
        if validate:
    ...
    def delete_security_scheme(
        ...
        raw_response = self.raw.delete_security_scheme(
            scheme_id=scheme_id,
        )
        if validate:
            return Dictionary(**raw_response.body)
