...
# Query params
SwapSchema = schemas.Int64Schema
...
RequestOptionalQueryParams = typing_extensions.TypedDict(
    ...
    {
        'swap': typing.Union[SwapSchema, decimal.Decimal, int, ],
    },
    total=False
)
...
request_query_swap = api_client.QueryParameter(
    name="swap",
...
class DeleteRoleRaw(BaseApi):
    ...
    async def adelete_role(
        ...
        **kwargs,
        ...
        args = self._delete_role_mapped_args(
            id=id,
            swap=swap,
        )
        return await self._adelete_role_oapg(
...
class DeleteRole(BaseApi):
    ...
    async def adelete_role(
        ...
        **kwargs,
        ...
        raw_response = await self.raw.adelete_role(
            id=id,
            swap=swap,
            **kwargs,
        )
    ...
    def delete_role(
        ...
        raw_response = self.raw.delete_role(
            id=id,
            swap=swap,
        )
