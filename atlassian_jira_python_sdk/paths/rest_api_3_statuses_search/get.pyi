...
from atlassian_jira_python_sdk.model.page_of_statuses import PageOfStatuses as PageOfStatusesSchema

from atlassian_jira_python_sdk.type.page_of_statuses import PageOfStatuses

from ...api_client import Dictionary
from atlassian_jira_python_sdk.pydantic.page_of_statuses import PageOfStatuses as PageOfStatusesPydantic
...
class SearchStringSchema(
    schemas.StrSchema
):
    pass
StatusCategorySchema = schemas.StrSchema
...
RequestOptionalQueryParams = typing_extensions.TypedDict(
    'RequestOptionalQueryParams',
    {
        ...
        'statusCategory': typing.Union[StatusCategorySchema, str, ],
    },
    total=False
)
...
request_query_status_category = api_client.QueryParameter(
    name="statusCategory",
    style=api_client.ParameterStyle.FORM,
    schema=StatusCategorySchema,
    explode=True,
)
SchemaFor200ResponseBodyApplicationJson = PageOfStatusesSchema
...
class BaseApi(api_client.Api):
    ...
    def _search_paginated_mapped_args(
        self,
        ...
        status_category: typing.Optional[str] = None,
        ...
        if status_category is not None:
            _query_params["statusCategory"] = status_category
        args.query = _query_params
        return args

    async def _asearch_paginated_oapg(
        self,
...
class SearchPaginatedRaw(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    async def asearch_paginated(
        self,
        expand: typing.Optional[str] = None,
        project_id: typing.Optional[str] = None,
        start_at: typing.Optional[int] = None,
        ...
        **kwargs,
        ...
        args = self._search_paginated_mapped_args(
            expand=expand,
        ...
        return await self._asearch_paginated_oapg(
    ...
    def search_paginated(
        ...
        return self._search_paginated_oapg(
            query_params=args.query,
        )

class SearchPaginated(BaseApi):
    ...
    async def asearch_paginated(
        ...
        validate: bool = False,
        **kwargs,
    ) -> PageOfStatusesPydantic:
        raw_response = await self.raw.asearch_paginated(
            expand=expand,
            project_id=project_id,
            start_at=start_at,
            max_results=max_results,
        ...
        if validate:
            return PageOfStatusesPydantic(**raw_response.body)
        return api_client.construct_model_instance(PageOfStatusesPydantic, raw_response.body)
    ...
    def search_paginated(
        ...
        raw_response = self.raw.search_paginated(
            expand=expand,
            project_id=project_id,
            start_at=start_at,
            max_results=max_results,
