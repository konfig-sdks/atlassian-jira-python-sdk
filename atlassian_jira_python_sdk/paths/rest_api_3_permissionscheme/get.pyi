...
from atlassian_jira_python_sdk.model.permission_schemes import PermissionSchemes as PermissionSchemesSchema

from atlassian_jira_python_sdk.type.permission_schemes import PermissionSchemes

from ...api_client import Dictionary
from atlassian_jira_python_sdk.pydantic.permission_schemes import PermissionSchemes as PermissionSchemesPydantic
...
SchemaFor200ResponseBodyApplicationJson = PermissionSchemesSchema
...
class GetAll(BaseApi):
    ...
    async def aget_all(
        ...
        validate: bool = False,
        **kwargs,
    ) -> PermissionSchemesPydantic:
        raw_response = await self.raw.aget_all(
            expand=expand,
            **kwargs,
        )
        if validate:
            return PermissionSchemesPydantic(**raw_response.body)
        return api_client.construct_model_instance(PermissionSchemesPydantic, raw_response.body)
