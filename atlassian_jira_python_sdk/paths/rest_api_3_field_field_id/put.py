...
from atlassian_jira_python_sdk.model.update_custom_field_details import UpdateCustomFieldDetails as UpdateCustomFieldDetailsSchema

from atlassian_jira_python_sdk.type.update_custom_field_details import UpdateCustomFieldDetails

from ...api_client import Dictionary
from atlassian_jira_python_sdk.pydantic.update_custom_field_details import UpdateCustomFieldDetails as UpdateCustomFieldDetailsPydantic
...
# body param
SchemaForRequestBodyApplicationJson = UpdateCustomFieldDetailsSchema


request_body_update_custom_field_details = api_client.RequestBody(
    content={
    ...
    async def _aupdate_custom_field_oapg(
        ...
        **kwargs,
        ...
        request_before_hook(
            ...
            path_template='/rest/api/3/field/{fieldId}',
            body=body,
            auth_settings=_auth,
            headers=_headers,
        )
        serialized_data = request_body_update_custom_field_details.serialize(body, content_type)
