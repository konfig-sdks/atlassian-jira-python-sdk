...
SchemaFor201ResponseBodyApplicationJson = CommentSchema
...
class BaseApi(api_client.Api):
    ...
    def _add_comment_to_issue_mapped_args(
        self,
        issue_id_or_key: str,
    ...
    async def _aadd_comment_to_issue_oapg(
        self,
    ...
    def _add_comment_to_issue_oapg(
        self,
        body: typing.Any = None,
            query_params: typing.Optional[dict] = {},
            path_params: typing.Optional[dict] = {},
...
class AddCommentToIssueRaw(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    async def aadd_comment_to_issue(
        self,
        issue_id_or_key: str,
        author: typing.Optional[UserDetails] = None,
        body: typing.Optional[typing.Union[bool, date, datetime, dict, float, int, list, str, None]] = None,
        ...
        **kwargs,
        ...
        args = self._add_comment_to_issue_mapped_args(
        ...
        return await self._aadd_comment_to_issue_oapg(
            body=args.body,
    ...
    def add_comment_to_issue(
        ...
        return self._add_comment_to_issue_oapg(
            body=args.body,
            query_params=args.query,
            path_params=args.path,
        )

class AddCommentToIssue(BaseApi):
    ...
    async def aadd_comment_to_issue(
        ...
        **kwargs,
        ...
        raw_response = await self.raw.aadd_comment_to_issue(
            issue_id_or_key=issue_id_or_key,
            author=author,
            body=body,
            created=created,
    ...
    def add_comment_to_issue(
        ...
        raw_response = self.raw.add_comment_to_issue(
            issue_id_or_key=issue_id_or_key,
            author=author,
            body=body,
            created=created,
