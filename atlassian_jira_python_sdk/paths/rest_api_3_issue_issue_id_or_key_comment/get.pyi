...
from atlassian_jira_python_sdk.model.page_of_comments import PageOfComments as PageOfCommentsSchema

from atlassian_jira_python_sdk.type.page_of_comments import PageOfComments

from ...api_client import Dictionary
from atlassian_jira_python_sdk.pydantic.page_of_comments import PageOfComments as PageOfCommentsPydantic
...
SchemaFor200ResponseBodyApplicationJson = PageOfCommentsSchema
...
class ListGet(BaseApi):
    ...
    async def alist_get(
        ...
        **kwargs,
        ...
        if validate:
            return PageOfCommentsPydantic(**raw_response.body)
        return api_client.construct_model_instance(PageOfCommentsPydantic, raw_response.body)
