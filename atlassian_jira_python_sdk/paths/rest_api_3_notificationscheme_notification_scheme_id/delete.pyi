...
class BaseApi(api_client.Api):
    ...
    def _remove_scheme_mapped_args(
        self,
    ...
    async def _aremove_scheme_oapg(
        self,
        ...
        **kwargs,
        ...
        request_before_hook(
            ...
            path_template='/rest/api/3/notificationscheme/{notificationSchemeId}',
            auth_settings=_auth,
            headers=_headers,
        )
...
class RemoveSchemeRaw(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    async def aremove_scheme(
        self,
        notification_scheme_id: str,
        **kwargs,
    ) -> typing.Union[
        ...
        args = self._remove_scheme_mapped_args(
            notification_scheme_id=notification_scheme_id,
        )
        return await self._aremove_scheme_oapg(
    ...
    def remove_scheme(
        ...
        return self._remove_scheme_oapg(
            path_params=args.path,
        )

class RemoveScheme(BaseApi):
    ...
    async def aremove_scheme(
        ...
        **kwargs,
        ...
        raw_response = await self.raw.aremove_scheme(
            notification_scheme_id=notification_scheme_id,
            **kwargs,
        )
        if validate:
    ...
    def remove_scheme(
        ...
        raw_response = self.raw.remove_scheme(
            notification_scheme_id=notification_scheme_id,
        )
        if validate:
            return Dictionary(**raw_response.body)
