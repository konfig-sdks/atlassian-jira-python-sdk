...
from atlassian_jira_python_sdk.model.resolution import Resolution as ResolutionSchema

from atlassian_jira_python_sdk.type.resolution import Resolution

from ...api_client import Dictionary
from atlassian_jira_python_sdk.pydantic.resolution import Resolution as ResolutionPydantic
...
SchemaFor200ResponseBodyApplicationJson = ResolutionSchema
...
class GetById(BaseApi):
    ...
    async def aget_by_id(
        ...
        **kwargs,
        ...
        if validate:
            return ResolutionPydantic(**raw_response.body)
        return api_client.construct_model_instance(ResolutionPydantic, raw_response.body)
