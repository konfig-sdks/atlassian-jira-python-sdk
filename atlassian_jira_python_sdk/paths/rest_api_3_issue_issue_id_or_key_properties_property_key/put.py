...
class BaseApi(api_client.Api):
    ...
    def _set_issue_property_mapped_args(
        self,
    ...
    async def _aset_issue_property_oapg(
        self,
...
class SetIssuePropertyRaw(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    async def aset_issue_property(
        self,
        body: typing.Union[bool, date, datetime, dict, float, int, list, str, None],
        issue_id_or_key: str,
        property_key: str,
        **kwargs,
        ...
        args = self._set_issue_property_mapped_args(
            body=body,
            issue_id_or_key=issue_id_or_key,
            property_key=property_key,
        )
        return await self._aset_issue_property_oapg(
            body=args.body,
    ...
    def set_issue_property(
        ...
        return self._set_issue_property_oapg(
            body=args.body,
            path_params=args.path,
        )

class SetIssueProperty(BaseApi):
    ...
    async def aset_issue_property(
        ...
        **kwargs,
        ...
        raw_response = await self.raw.aset_issue_property(
            body=body,
            issue_id_or_key=issue_id_or_key,
            property_key=property_key,
            **kwargs,
    ...
    def set_issue_property(
        ...
        raw_response = self.raw.set_issue_property(
            body=body,
            issue_id_or_key=issue_id_or_key,
            property_key=property_key,
        )
