...
class BaseApi(api_client.Api):
    ...
    def _remove_favorite_mapped_args(
        self,
        id: int,
    ...
    async def _aremove_favorite_oapg(
        self,
...
class RemoveFavoriteRaw(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    async def aremove_favorite(
        self,
        id: int,
        expand: typing.Optional[str] = None,
        **kwargs,
        ...
        args = self._remove_favorite_mapped_args(
            id=id,
            expand=expand,
        )
        return await self._aremove_favorite_oapg(
    ...
    def remove_favorite(
        ...
        return self._remove_favorite_oapg(
            query_params=args.query,
            path_params=args.path,
        )

class RemoveFavorite(BaseApi):
    ...
    async def aremove_favorite(
        ...
        **kwargs,
        ...
        raw_response = await self.raw.aremove_favorite(
            id=id,
            expand=expand,
            **kwargs,
        )
    ...
    def remove_favorite(
        ...
        raw_response = self.raw.remove_favorite(
            id=id,
            expand=expand,
        )
        if validate:
