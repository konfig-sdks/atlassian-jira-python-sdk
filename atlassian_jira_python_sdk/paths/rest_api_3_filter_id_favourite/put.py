...
class BaseApi(api_client.Api):
    ...
    def _add_as_favorite_mapped_args(
        self,
        id: int,
    ...
    async def _aadd_as_favorite_oapg(
        self,
...
class AddAsFavoriteRaw(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    async def aadd_as_favorite(
        self,
        id: int,
        expand: typing.Optional[str] = None,
        **kwargs,
        ...
        args = self._add_as_favorite_mapped_args(
            id=id,
            expand=expand,
        )
        return await self._aadd_as_favorite_oapg(
    ...
    def add_as_favorite(
        ...
        return self._add_as_favorite_oapg(
            query_params=args.query,
            path_params=args.path,
        )

class AddAsFavorite(BaseApi):
    ...
    async def aadd_as_favorite(
        ...
        **kwargs,
        ...
        raw_response = await self.raw.aadd_as_favorite(
            id=id,
            expand=expand,
            **kwargs,
        )
    ...
    def add_as_favorite(
        ...
        raw_response = self.raw.add_as_favorite(
            id=id,
            expand=expand,
        )
        if validate:
