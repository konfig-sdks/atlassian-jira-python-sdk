...
class BaseApi(api_client.Api):
    ...
    def _create_draft_workflow_scheme_mapped_args(
        self,
        id: int,
    ...
    async def _acreate_draft_workflow_scheme_oapg(
        self,
    ...
    def _create_draft_workflow_scheme_oapg(
        self,
            path_params: typing.Optional[dict] = {},
        skip_deserialization: bool = True,
        timeout: typing.Optional[typing.Union[float, typing.Tuple]] = None,
...
class CreateDraftWorkflowSchemeRaw(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    async def acreate_draft_workflow_scheme(
        self,
        id: int,
        **kwargs,
    ) -> typing.Union[
        ...
        args = self._create_draft_workflow_scheme_mapped_args(
            id=id,
        )
        return await self._acreate_draft_workflow_scheme_oapg(
            path_params=args.path,
            **kwargs,
        )
    
    def create_draft_workflow_scheme(
        self,
        id: int,
    ) -> typing.Union[
        ApiResponseFor201,
        ...
        return self._create_draft_workflow_scheme_oapg(
            path_params=args.path,
        )

class CreateDraftWorkflowScheme(BaseApi):
    ...
    async def acreate_draft_workflow_scheme(
        ...
        **kwargs,
        ...
        raw_response = await self.raw.acreate_draft_workflow_scheme(
            id=id,
            **kwargs,
        )
        if validate:
    ...
    def create_draft_workflow_scheme(
        ...
        raw_response = self.raw.create_draft_workflow_scheme(
            id=id,
        )
        if validate:
            return WorkflowSchemePydantic(**raw_response.body)
