...
from atlassian_jira_python_sdk.model.page_bean_security_level_member import PageBeanSecurityLevelMember as PageBeanSecurityLevelMemberSchema

from atlassian_jira_python_sdk.type.page_bean_security_level_member import PageBeanSecurityLevelMember

from ...api_client import Dictionary
from atlassian_jira_python_sdk.pydantic.page_bean_security_level_member import PageBeanSecurityLevelMember as PageBeanSecurityLevelMemberPydantic
...
RequestOptionalQueryParams = typing_extensions.TypedDict(
    'RequestOptionalQueryParams',
    {
        ...
        'levelId': typing.Union[LevelIdSchema, list, tuple, ],
...
request_query_level_id = api_client.QueryParameter(
    name="levelId",
    style=api_client.ParameterStyle.FORM,
...
SchemaFor200ResponseBodyApplicationJson = PageBeanSecurityLevelMemberSchema
...
class BaseApi(api_client.Api):
    ...
    def _get_level_members_mapped_args(
        ...
        level_id: typing.Optional[typing.List[str]] = None,
        ...
        if level_id is not None:
            _query_params["levelId"] = level_id
...
class GetLevelMembers(BaseApi):
    ...
    async def aget_level_members(
        ...
        validate: bool = False,
        **kwargs,
    ) -> PageBeanSecurityLevelMemberPydantic:
        ...
        if validate:
            return PageBeanSecurityLevelMemberPydantic(**raw_response.body)
        return api_client.construct_model_instance(PageBeanSecurityLevelMemberPydantic, raw_response.body)
