...
class AddWatcherRaw(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    async def aadd_watcher(
        self,
        body: str,
        issue_id_or_key: str,
        **kwargs,
        ...
        args = self._add_watcher_mapped_args(
            body=body,
            issue_id_or_key=issue_id_or_key,
        )
        return await self._aadd_watcher_oapg(
            body=args.body,
    ...
    def add_watcher(
        ...
        return self._add_watcher_oapg(
            body=args.body,
            path_params=args.path,
        )

class AddWatcher(BaseApi):
    ...
    async def aadd_watcher(
        ...
        **kwargs,
        ...
        raw_response = await self.raw.aadd_watcher(
            body=body,
            issue_id_or_key=issue_id_or_key,
            **kwargs,
        )
    ...
    def add_watcher(
        ...
        raw_response = self.raw.add_watcher(
            body=body,
            issue_id_or_key=issue_id_or_key,
        )
        if validate:
