...
from atlassian_jira_python_sdk.model.security_level import SecurityLevel as SecurityLevelSchema

from atlassian_jira_python_sdk.type.security_level import SecurityLevel

from ...api_client import Dictionary
from atlassian_jira_python_sdk.pydantic.security_level import SecurityLevel as SecurityLevelPydantic
...
SchemaFor200ResponseBodyApplicationJson = SecurityLevelSchema
...
class GetDetails(BaseApi):
    ...
    async def aget_details(
        ...
        validate: bool = False,
        **kwargs,
    ) -> SecurityLevelPydantic:
        raw_response = await self.raw.aget_details(
            id=id,
            **kwargs,
        )
        if validate:
            return SecurityLevelPydantic(**raw_response.body)
        return api_client.construct_model_instance(SecurityLevelPydantic, raw_response.body)
