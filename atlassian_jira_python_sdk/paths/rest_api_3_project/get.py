...
from atlassian_jira_python_sdk.model.projects_get_all_response import ProjectsGetAllResponse as ProjectsGetAllResponseSchema

from atlassian_jira_python_sdk.type.projects_get_all_response import ProjectsGetAllResponse

from ...api_client import Dictionary
from atlassian_jira_python_sdk.pydantic.projects_get_all_response import ProjectsGetAllResponse as ProjectsGetAllResponsePydantic

from . import path

# Query params
ExpandSchema = schemas.StrSchema
RecentSchema = schemas.Int32Schema
...
RequestOptionalQueryParams = typing_extensions.TypedDict(
    'RequestOptionalQueryParams',
    {
        ...
        'recent': typing.Union[RecentSchema, decimal.Decimal, int, ],
...
request_query_recent = api_client.QueryParameter(
    name="recent",
    style=api_client.ParameterStyle.FORM,
    schema=RecentSchema,
    explode=True,
...
class GetAll(BaseApi):
    ...
    async def aget_all(
        ...
        **kwargs,
        ...
        if validate:
            return RootModel[ProjectsGetAllResponsePydantic](raw_response.body).root
