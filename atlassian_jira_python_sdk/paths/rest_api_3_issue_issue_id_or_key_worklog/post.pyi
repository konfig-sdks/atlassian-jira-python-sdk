...
ReduceBySchema = schemas.StrSchema
...
RequestOptionalQueryParams = typing_extensions.TypedDict(
    'RequestOptionalQueryParams',
    {
        ...
        'reduceBy': typing.Union[ReduceBySchema, str, ],
...
request_query_reduce_by = api_client.QueryParameter(
    name="reduceBy",
    style=api_client.ParameterStyle.FORM,
    schema=ReduceBySchema,
    explode=True,
)
...
SchemaFor201ResponseBodyApplicationJson = WorklogSchema
...
class BaseApi(api_client.Api):
    ...
    def _create_worklog_mapped_args(
        self,
        issue_id_or_key: str,
        ...
        reduce_by: typing.Optional[str] = None,
        ...
        if reduce_by is not None:
            _query_params["reduceBy"] = reduce_by
    ...
    async def _acreate_worklog_oapg(
        self,
...
class CreateWorklogRaw(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    async def acreate_worklog(
        self,
        issue_id_or_key: str,
        author: typing.Optional[UserDetails] = None,
        comment: typing.Optional[typing.Union[bool, date, datetime, dict, float, int, list, str, None]] = None,
        ...
        **kwargs,
        ...
        args = self._create_worklog_mapped_args(
        ...
        return await self._acreate_worklog_oapg(
            body=args.body,
    ...
    def create_worklog(
        ...
        return self._create_worklog_oapg(
            body=args.body,
            query_params=args.query,
            path_params=args.path,
        )

class CreateWorklog(BaseApi):
    ...
    async def acreate_worklog(
        ...
        **kwargs,
        ...
        raw_response = await self.raw.acreate_worklog(
            issue_id_or_key=issue_id_or_key,
            author=author,
            comment=comment,
            created=created,
    ...
    def create_worklog(
        ...
        raw_response = self.raw.create_worklog(
            issue_id_or_key=issue_id_or_key,
            author=author,
            comment=comment,
            created=created,
