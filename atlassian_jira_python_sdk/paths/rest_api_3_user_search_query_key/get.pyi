...
from atlassian_jira_python_sdk.model.page_bean_user_key import PageBeanUserKey as PageBeanUserKeySchema

from atlassian_jira_python_sdk.type.error_collection import ErrorCollection
from atlassian_jira_python_sdk.type.page_bean_user_key import PageBeanUserKey

from ...api_client import Dictionary
from atlassian_jira_python_sdk.pydantic.page_bean_user_key import PageBeanUserKey as PageBeanUserKeyPydantic
...
SchemaFor200ResponseBodyApplicationJson = PageBeanUserKeySchema
...
class BaseApi(api_client.Api):
    ...
    def _find_users_by_query_0_mapped_args(
        self,
        query: str,
    ...
    async def _afind_users_by_query_0_oapg(
        self,
    ...
    def _find_users_by_query_0_oapg(
        self,
            query_params: typing.Optional[dict] = {},
        skip_deserialization: bool = True,
        timeout: typing.Optional[typing.Union[float, typing.Tuple]] = None,
...
class FindUsersByQuery0Raw(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    async def afind_users_by_query_0(
        self,
        query: str,
        start_at: typing.Optional[int] = None,
        max_result: typing.Optional[int] = None,
        **kwargs,
        ...
        args = self._find_users_by_query_0_mapped_args(
            query=query,
            start_at=start_at,
            max_result=max_result,
        )
        return await self._afind_users_by_query_0_oapg(
            query_params=args.query,
            **kwargs,
        )
    
    def find_users_by_query_0(
        self,
        query: str,
        start_at: typing.Optional[int] = None,
        max_result: typing.Optional[int] = None,
        ...
        return self._find_users_by_query_0_oapg(
            query_params=args.query,
        )

class FindUsersByQuery0(BaseApi):
    ...
    async def afind_users_by_query_0(
        ...
        validate: bool = False,
        **kwargs,
    ) -> PageBeanUserKeyPydantic:
        raw_response = await self.raw.afind_users_by_query_0(
            query=query,
            start_at=start_at,
            max_result=max_result,
            **kwargs,
        ...
        if validate:
            return PageBeanUserKeyPydantic(**raw_response.body)
        return api_client.construct_model_instance(PageBeanUserKeyPydantic, raw_response.body)
    ...
    def find_users_by_query_0(
        ...
        raw_response = self.raw.find_users_by_query_0(
            query=query,
            start_at=start_at,
            max_result=max_result,
        )
