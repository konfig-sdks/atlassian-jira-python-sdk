...
class BaseApi(api_client.Api):
    ...
    def _get_property_key_mapped_args(
        self,
        issue_type_id: str,
        property_key: str,
    ...
    async def _aget_property_key_oapg(
        self,
        ...
        **kwargs,
        ...
        request_before_hook(
            ...
            path_template='/rest/api/3/issuetype/{issueTypeId}/properties/{propertyKey}',
            auth_settings=_auth,
            headers=_headers,
        )
...
class GetPropertyKeyRaw(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    async def aget_property_key(
        self,
        issue_type_id: str,
        property_key: str,
        **kwargs,
        ...
        args = self._get_property_key_mapped_args(
            issue_type_id=issue_type_id,
            property_key=property_key,
        )
        return await self._aget_property_key_oapg(
    ...
    def get_property_key(
        ...
        return self._get_property_key_oapg(
            path_params=args.path,
        )

class GetPropertyKey(BaseApi):
    ...
    async def aget_property_key(
        ...
        **kwargs,
        ...
        raw_response = await self.raw.aget_property_key(
            issue_type_id=issue_type_id,
            property_key=property_key,
            **kwargs,
        )
    ...
    def get_property_key(
        ...
        raw_response = self.raw.get_property_key(
            issue_type_id=issue_type_id,
            property_key=property_key,
        )
        if validate:
