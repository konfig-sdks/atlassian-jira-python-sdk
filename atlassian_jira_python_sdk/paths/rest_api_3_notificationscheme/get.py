...
from atlassian_jira_python_sdk.model.page_bean_notification_scheme import PageBeanNotificationScheme as PageBeanNotificationSchemeSchema

from atlassian_jira_python_sdk.type.page_bean_notification_scheme import PageBeanNotificationScheme

from ...api_client import Dictionary
from atlassian_jira_python_sdk.pydantic.page_bean_notification_scheme import PageBeanNotificationScheme as PageBeanNotificationSchemePydantic
...
SchemaFor200ResponseBodyApplicationJson = PageBeanNotificationSchemeSchema
...
class BaseApi(api_client.Api):
    ...
    def _list_notification_schemes_paginated_mapped_args(
        self,
    ...
    async def _alist_notification_schemes_paginated_oapg(
        self,
    ...
    def _list_notification_schemes_paginated_oapg(
        self,
            query_params: typing.Optional[dict] = {},
        skip_deserialization: bool = True,
        timeout: typing.Optional[typing.Union[float, typing.Tuple]] = None,
...
class ListNotificationSchemesPaginatedRaw(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    async def alist_notification_schemes_paginated(
        self,
        start_at: typing.Optional[str] = None,
        max_results: typing.Optional[str] = None,
        id: typing.Optional[typing.List[str]] = None,
        ...
        **kwargs,
        ...
        args = self._list_notification_schemes_paginated_mapped_args(
            start_at=start_at,
        ...
        return await self._alist_notification_schemes_paginated_oapg(
            query_params=args.query,
            **kwargs,
        )
    
    def list_notification_schemes_paginated(
        self,
        start_at: typing.Optional[str] = None,
        max_results: typing.Optional[str] = None,
        id: typing.Optional[typing.List[str]] = None,
        ...
        return self._list_notification_schemes_paginated_oapg(
            query_params=args.query,
        )

class ListNotificationSchemesPaginated(BaseApi):
    ...
    async def alist_notification_schemes_paginated(
        ...
        validate: bool = False,
        **kwargs,
    ) -> PageBeanNotificationSchemePydantic:
        raw_response = await self.raw.alist_notification_schemes_paginated(
            start_at=start_at,
            max_results=max_results,
            id=id,
            project_id=project_id,
        ...
        if validate:
            return PageBeanNotificationSchemePydantic(**raw_response.body)
        return api_client.construct_model_instance(PageBeanNotificationSchemePydantic, raw_response.body)
    ...
    def list_notification_schemes_paginated(
        ...
        raw_response = self.raw.list_notification_schemes_paginated(
            start_at=start_at,
            max_results=max_results,
            id=id,
            project_id=project_id,
