...
from atlassian_jira_python_sdk.model.page_bean_changelog import PageBeanChangelog as PageBeanChangelogSchema

from atlassian_jira_python_sdk.type.page_bean_changelog import PageBeanChangelog

from ...api_client import Dictionary
from atlassian_jira_python_sdk.pydantic.page_bean_changelog import PageBeanChangelog as PageBeanChangelogPydantic
...
SchemaFor200ResponseBodyApplicationJson = PageBeanChangelogSchema
...
class BaseApi(api_client.Api):
    ...
    def _get_changelogs_mapped_args(
        self,
        issue_id_or_key: str,
    ...
    async def _aget_changelogs_oapg(
        self,
        ...
        **kwargs,
        ...
        request_before_hook(
            ...
            path_template='/rest/api/3/issue/{issueIdOrKey}/changelog',
            auth_settings=_auth,
            headers=_headers,
        )
...
class GetChangelogsRaw(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    async def aget_changelogs(
        self,
        issue_id_or_key: str,
        start_at: typing.Optional[int] = None,
        max_results: typing.Optional[int] = None,
        **kwargs,
        ...
        args = self._get_changelogs_mapped_args(
            issue_id_or_key=issue_id_or_key,
            start_at=start_at,
            max_results=max_results,
        )
        return await self._aget_changelogs_oapg(
    ...
    def get_changelogs(
        ...
        return self._get_changelogs_oapg(
            query_params=args.query,
            path_params=args.path,
        )

class GetChangelogs(BaseApi):
    ...
    async def aget_changelogs(
        ...
        validate: bool = False,
        **kwargs,
    ) -> PageBeanChangelogPydantic:
        raw_response = await self.raw.aget_changelogs(
            issue_id_or_key=issue_id_or_key,
            start_at=start_at,
            max_results=max_results,
            **kwargs,
        ...
        if validate:
            return PageBeanChangelogPydantic(**raw_response.body)
        return api_client.construct_model_instance(PageBeanChangelogPydantic, raw_response.body)
    ...
    def get_changelogs(
        ...
        raw_response = self.raw.get_changelogs(
            issue_id_or_key=issue_id_or_key,
            start_at=start_at,
            max_results=max_results,
        )
