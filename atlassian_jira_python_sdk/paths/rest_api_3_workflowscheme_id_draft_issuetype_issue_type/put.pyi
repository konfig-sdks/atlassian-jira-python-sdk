...
# body param
SchemaForRequestBodyApplicationJson = IssueTypeWorkflowMappingSchema


request_body_issue_type_workflow_mapping = api_client.RequestBody(
    content={
...
class BaseApi(api_client.Api):
    ...
    def _set_issue_type_workflow_mapped_args(
        self,
        id: int,
        issue_type: str,
    ...
    async def _aset_issue_type_workflow_oapg(
        self,
        ...
        **kwargs,
        ...
        request_before_hook(
            ...
            path_template='/rest/api/3/workflowscheme/{id}/draft/issuetype/{issueType}',
            body=body,
            auth_settings=_auth,
            headers=_headers,
        )
        serialized_data = request_body_issue_type_workflow_mapping.serialize(body, content_type)
    ...
    def _set_issue_type_workflow_oapg(
        self,
        body: typing.Any = None,
            path_params: typing.Optional[dict] = {},
        skip_deserialization: bool = True,
...
class SetIssueTypeWorkflowRaw(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    async def aset_issue_type_workflow(
        self,
        id: int,
        issue_type: str,
        issue_type: typing.Optional[str] = None,
        ...
        **kwargs,
        ...
        args = self._set_issue_type_workflow_mapped_args(
            id=id,
        ...
        return await self._aset_issue_type_workflow_oapg(
            body=args.body,
            path_params=args.path,
            **kwargs,
        )
    
    def set_issue_type_workflow(
        self,
        id: int,
        issue_type: str,
        issue_type: typing.Optional[str] = None,
        ...
        return self._set_issue_type_workflow_oapg(
            body=args.body,
            path_params=args.path,
        )

class SetIssueTypeWorkflow(BaseApi):
    ...
    async def aset_issue_type_workflow(
        ...
        **kwargs,
        ...
        raw_response = await self.raw.aset_issue_type_workflow(
            id=id,
            issue_type=issue_type,
            issue_type=issue_type,
            update_draft_if_needed=update_draft_if_needed,
    ...
    def set_issue_type_workflow(
        ...
        raw_response = self.raw.set_issue_type_workflow(
            id=id,
            issue_type=issue_type,
            issue_type=issue_type,
            update_draft_if_needed=update_draft_if_needed,
