...
class BaseApi(api_client.Api):
    ...
    def _get_property_value_mapped_args(
        self,
        comment_id: str,
        property_key: str,
    ...
    async def _aget_property_value_oapg(
        self,
        ...
        **kwargs,
        ...
        request_before_hook(
            ...
            path_template='/rest/api/3/comment/{commentId}/properties/{propertyKey}',
            auth_settings=_auth,
            headers=_headers,
        )
...
class GetPropertyValueRaw(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    async def aget_property_value(
        self,
        comment_id: str,
        property_key: str,
        **kwargs,
        ...
        args = self._get_property_value_mapped_args(
            comment_id=comment_id,
            property_key=property_key,
        )
        return await self._aget_property_value_oapg(
    ...
    def get_property_value(
        ...
        return self._get_property_value_oapg(
            path_params=args.path,
        )

class GetPropertyValue(BaseApi):
    ...
    async def aget_property_value(
        ...
        **kwargs,
        ...
        raw_response = await self.raw.aget_property_value(
            comment_id=comment_id,
            property_key=property_key,
            **kwargs,
        )
    ...
    def get_property_value(
        ...
        raw_response = self.raw.get_property_value(
            comment_id=comment_id,
            property_key=property_key,
        )
        if validate:
