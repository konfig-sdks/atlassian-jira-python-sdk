...
from atlassian_jira_python_sdk.model.application_role import ApplicationRole as ApplicationRoleSchema

from atlassian_jira_python_sdk.type.application_role import ApplicationRole

from ...api_client import Dictionary
from atlassian_jira_python_sdk.pydantic.application_role import ApplicationRole as ApplicationRolePydantic
...
SchemaFor200ResponseBodyApplicationJson = ApplicationRoleSchema
...
class GetRole(BaseApi):
    ...
    async def aget_role(
        ...
        validate: bool = False,
        **kwargs,
    ) -> ApplicationRolePydantic:
        raw_response = await self.raw.aget_role(
            key=key,
            **kwargs,
        )
        if validate:
            return ApplicationRolePydantic(**raw_response.body)
        return api_client.construct_model_instance(ApplicationRolePydantic, raw_response.body)
