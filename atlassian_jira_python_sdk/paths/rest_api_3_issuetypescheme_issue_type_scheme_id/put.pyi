...
from atlassian_jira_python_sdk.model.issue_type_scheme_update_details import IssueTypeSchemeUpdateDetails as IssueTypeSchemeUpdateDetailsSchema

from atlassian_jira_python_sdk.type.issue_type_scheme_update_details import IssueTypeSchemeUpdateDetails

from ...api_client import Dictionary
from atlassian_jira_python_sdk.pydantic.issue_type_scheme_update_details import IssueTypeSchemeUpdateDetails as IssueTypeSchemeUpdateDetailsPydantic
...
# body param
SchemaForRequestBodyApplicationJson = IssueTypeSchemeUpdateDetailsSchema


request_body_issue_type_scheme_update_details = api_client.RequestBody(
    content={
    ...
    async def _aupdate_scheme_oapg(
        ...
        **kwargs,
        ...
        request_before_hook(
            ...
            path_template='/rest/api/3/issuetypescheme/{issueTypeSchemeId}',
            body=body,
            auth_settings=_auth,
            headers=_headers,
        )
        serialized_data = request_body_issue_type_scheme_update_details.serialize(body, content_type)
