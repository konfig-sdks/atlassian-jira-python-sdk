...
class BaseApi(api_client.Api):
    ...
    def _get_item_property_mapped_args(
        self,
        dashboard_id: str,
        item_id: str,
        property_key: str,
    ...
    async def _aget_item_property_oapg(
        self,
...
class GetItemPropertyRaw(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    async def aget_item_property(
        self,
        dashboard_id: str,
        item_id: str,
        property_key: str,
        **kwargs,
        ...
        args = self._get_item_property_mapped_args(
            dashboard_id=dashboard_id,
            item_id=item_id,
            property_key=property_key,
        )
        return await self._aget_item_property_oapg(
    ...
    def get_item_property(
        ...
        return self._get_item_property_oapg(
            path_params=args.path,
        )

class GetItemProperty(BaseApi):
    ...
    async def aget_item_property(
        ...
        **kwargs,
        ...
        raw_response = await self.raw.aget_item_property(
            dashboard_id=dashboard_id,
            item_id=item_id,
            property_key=property_key,
            **kwargs,
    ...
    def get_item_property(
        ...
        raw_response = self.raw.get_item_property(
            dashboard_id=dashboard_id,
            item_id=item_id,
            property_key=property_key,
        )
