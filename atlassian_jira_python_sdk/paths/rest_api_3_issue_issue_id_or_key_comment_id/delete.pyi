...
class BaseApi(api_client.Api):
    ...
    def _delete_comment_mapped_args(
        self,
        issue_id_or_key: str,
        id: str,
    ...
    async def _adelete_comment_oapg(
        self,
...
class DeleteCommentRaw(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    async def adelete_comment(
        self,
        issue_id_or_key: str,
        id: str,
        **kwargs,
        ...
        args = self._delete_comment_mapped_args(
            issue_id_or_key=issue_id_or_key,
            id=id,
        )
        return await self._adelete_comment_oapg(
    ...
    def delete_comment(
        ...
        return self._delete_comment_oapg(
            path_params=args.path,
        )
...
class DeleteComment(BaseApi):
    ...
    async def adelete_comment(
        ...
        **kwargs,
        ...
        raw_response = await self.raw.adelete_comment(
            issue_id_or_key=issue_id_or_key,
            id=id,
            **kwargs,
        )
    ...
    def delete_comment(
        ...
        raw_response = self.raw.delete_comment(
            issue_id_or_key=issue_id_or_key,
            id=id,
        )
