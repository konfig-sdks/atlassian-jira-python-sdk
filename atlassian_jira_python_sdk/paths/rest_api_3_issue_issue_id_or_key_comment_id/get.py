...
class BaseApi(api_client.Api):
    ...
    def _get_comment_by_id_mapped_args(
        self,
        issue_id_or_key: str,
        id: str,
    ...
    async def _aget_comment_by_id_oapg(
        self,
...
class GetCommentByIdRaw(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    async def aget_comment_by_id(
        self,
        issue_id_or_key: str,
        id: str,
        expand: typing.Optional[str] = None,
        **kwargs,
        ...
        args = self._get_comment_by_id_mapped_args(
            issue_id_or_key=issue_id_or_key,
            id=id,
            expand=expand,
        )
        return await self._aget_comment_by_id_oapg(
    ...
    def get_comment_by_id(
        ...
        return self._get_comment_by_id_oapg(
            query_params=args.query,
            path_params=args.path,
        )

class GetCommentById(BaseApi):
    ...
    async def aget_comment_by_id(
        ...
        **kwargs,
        ...
        raw_response = await self.raw.aget_comment_by_id(
            issue_id_or_key=issue_id_or_key,
            id=id,
            expand=expand,
            **kwargs,
    ...
    def get_comment_by_id(
        ...
        raw_response = self.raw.get_comment_by_id(
            issue_id_or_key=issue_id_or_key,
            id=id,
            expand=expand,
        )
