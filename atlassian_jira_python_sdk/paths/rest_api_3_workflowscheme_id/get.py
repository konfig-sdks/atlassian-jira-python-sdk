...
class BaseApi(api_client.Api):
    ...
    def _get_scheme_by_id_mapped_args(
        self,
        id: int,
    ...
    async def _aget_scheme_by_id_oapg(
        self,
...
class GetSchemeByIdRaw(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    async def aget_scheme_by_id(
        self,
        id: int,
        return_draft_if_exists: typing.Optional[bool] = None,
        **kwargs,
        ...
        args = self._get_scheme_by_id_mapped_args(
            id=id,
            return_draft_if_exists=return_draft_if_exists,
        )
        return await self._aget_scheme_by_id_oapg(
    ...
    def get_scheme_by_id(
        ...
        return self._get_scheme_by_id_oapg(
            query_params=args.query,
            path_params=args.path,
        )

class GetSchemeById(BaseApi):
    ...
    async def aget_scheme_by_id(
        ...
        **kwargs,
        ...
        raw_response = await self.raw.aget_scheme_by_id(
            id=id,
            return_draft_if_exists=return_draft_if_exists,
            **kwargs,
        )
    ...
    def get_scheme_by_id(
        ...
        raw_response = self.raw.get_scheme_by_id(
            id=id,
            return_draft_if_exists=return_draft_if_exists,
        )
        if validate:
