...
class BaseApi(api_client.Api):
    ...
    def _get_draft_workflow_scheme_mapped_args(
        self,
        id: int,
    ...
    async def _aget_draft_workflow_scheme_oapg(
        self,
    ...
    def _get_draft_workflow_scheme_oapg(
        self,
            path_params: typing.Optional[dict] = {},
        skip_deserialization: bool = True,
        timeout: typing.Optional[typing.Union[float, typing.Tuple]] = None,
...
class GetDraftWorkflowSchemeRaw(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    async def aget_draft_workflow_scheme(
        self,
        id: int,
        **kwargs,
    ) -> typing.Union[
        ...
        args = self._get_draft_workflow_scheme_mapped_args(
            id=id,
        )
        return await self._aget_draft_workflow_scheme_oapg(
            path_params=args.path,
            **kwargs,
        )
    
    def get_draft_workflow_scheme(
        self,
        id: int,
    ) -> typing.Union[
        ApiResponseFor200,
        ...
        return self._get_draft_workflow_scheme_oapg(
            path_params=args.path,
        )

class GetDraftWorkflowScheme(BaseApi):
    ...
    async def aget_draft_workflow_scheme(
        ...
        **kwargs,
        ...
        raw_response = await self.raw.aget_draft_workflow_scheme(
            id=id,
            **kwargs,
        )
        if validate:
    ...
    def get_draft_workflow_scheme(
        ...
        raw_response = self.raw.get_draft_workflow_scheme(
            id=id,
        )
        if validate:
            return WorkflowSchemePydantic(**raw_response.body)
