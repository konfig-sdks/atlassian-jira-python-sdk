...
class PageBeanString(
    ...
    class MetaOapg:
        ...
        class properties:
            ...
            @staticmethod
            def values() -> typing.Type['PageBeanStringValues']:
                return PageBeanStringValues
            __annotations__ = {
                "isLast": isLast,
    ...
    @typing.overload
    def __getitem__(self, name: typing_extensions.Literal["values"]) -> 'PageBeanStringValues': ...
    ...
    @typing.overload
    def get_item_oapg(self, name: typing_extensions.Literal["values"]) -> typing.Union['PageBeanStringValues', schemas.Unset]: ...
    ...
    def __new__(
        ...
        *args: typing.Union[dict, frozendict.frozendict, ],
        ...
        values: typing.Union['PageBeanStringValues', schemas.Unset] = schemas.unset,
