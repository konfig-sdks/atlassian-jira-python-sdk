        ...
        class properties:
            ...
            class queries(
                ...
                class MetaOapg:
                    ...
                    @staticmethod
                    def items() -> typing.Type['JqlQueryToSanitize']:
                        return JqlQueryToSanitize
            
                def __new__(
                    cls,
                    arg: typing.Union[typing.Tuple['JqlQueryToSanitize'], typing.List['JqlQueryToSanitize']],
                ...
                def __getitem__(self, i: int) -> 'JqlQueryToSanitize':
