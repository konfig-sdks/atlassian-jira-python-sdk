...
class OperationMessage(
    ...
    def __getitem__(self, name: typing.Union[typing_extensions.Literal["message", "statusCode", ], str]):
    ...
    def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["message", "statusCode", ], str]):
