...
class IssueTypeDetails(
    ...
    def __getitem__(self, name: typing.Union[typing_extensions.Literal["description", "avatarId", "entityId", "hierarchyLevel", "iconUrl", "id", "name", "scope", "self", "subtask", ], str]):
    ...
    def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["description", "avatarId", "entityId", "hierarchyLevel", "iconUrl", "id", "name", "scope", "self", "subtask", ], str]):
