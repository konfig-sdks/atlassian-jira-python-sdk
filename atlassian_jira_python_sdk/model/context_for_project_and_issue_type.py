...
class ContextForProjectAndIssueType(
    ...
    def __getitem__(self, name: typing.Union[typing_extensions.Literal["contextId", "issueTypeId", "projectId", ], str]):
    ...
    def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["contextId", "issueTypeId", "projectId", ], str]):
