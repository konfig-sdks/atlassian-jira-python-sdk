...
class PaginatedResponseFieldCreateMetadata(
    ...
    def __getitem__(self, name: typing.Union[typing_extensions.Literal["maxResults", "results", "startAt", "total", ], str]):
    ...
    def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["maxResults", "results", "startAt", "total", ], str]):
