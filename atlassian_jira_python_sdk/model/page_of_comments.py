...
class PageOfComments(
    ...
    def __getitem__(self, name: typing.Union[typing_extensions.Literal["comments"], typing_extensions.Literal["maxResults"], typing_extensions.Literal["startAt"], typing_extensions.Literal["total"], str, ]):
    ...
    def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["comments"], typing_extensions.Literal["maxResults"], typing_extensions.Literal["startAt"], typing_extensions.Literal["total"], str, ]):
