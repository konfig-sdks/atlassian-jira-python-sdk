...
class CustomFieldContextDefaultValueForgeDateTimeField(
    ...
    def __getitem__(self, name: typing.Union[typing_extensions.Literal["contextId", "type", "dateTime", "useCurrent", ], str]):
    ...
    def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["contextId", "type", "dateTime", "useCurrent", ], str]):
