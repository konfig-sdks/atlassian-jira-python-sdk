...
class CustomFieldContextDefaultValueForgeObjectField(
    ...
    def __getitem__(self, name: typing.Union[typing_extensions.Literal["type", "object", ], str]):
    ...
    def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["type", "object", ], str]):
