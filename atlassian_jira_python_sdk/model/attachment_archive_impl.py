...
class AttachmentArchiveImpl(
    ...
    def __getitem__(self, name: typing.Union[typing_extensions.Literal["entries", "totalEntryCount", ], str]):
    ...
    def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["entries", "totalEntryCount", ], str]):
