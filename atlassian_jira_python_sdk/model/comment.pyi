...
class Comment(
    ...
    class MetaOapg:
        ...
        class properties:
            ...
            jsdAuthorCanSeeRequest = schemas.BoolSchema
            jsdPublic = schemas.BoolSchema
            ...
            renderedBody = schemas.StrSchema
    ...
    @typing.overload
    def __getitem__(self, name: typing_extensions.Literal["jsdAuthorCanSeeRequest"]) -> MetaOapg.properties.jsdAuthorCanSeeRequest: ...
    
    @typing.overload
    def __getitem__(self, name: typing_extensions.Literal["jsdPublic"]) -> MetaOapg.properties.jsdPublic: ...
    
    @typing.overload
    def __getitem__(self, name: typing_extensions.Literal["properties"]) -> MetaOapg.properties.properties: ...
    
    @typing.overload
    def __getitem__(self, name: typing_extensions.Literal["renderedBody"]) -> MetaOapg.properties.renderedBody: ...
    ...
    def __getitem__(self, name: typing.Union[typing_extensions.Literal["author"], typing_extensions.Literal["body"], typing_extensions.Literal["created"], typing_extensions.Literal["id"], typing_extensions.Literal["jsdAuthorCanSeeRequest"], typing_extensions.Literal["jsdPublic"], typing_extensions.Literal["properties"], typing_extensions.Literal["renderedBody"], typing_extensions.Literal["self"], typing_extensions.Literal["updateAuthor"], typing_extensions.Literal["updated"], typing_extensions.Literal["visibility"], str, ]):
    ...
    @typing.overload
    def get_item_oapg(self, name: typing_extensions.Literal["jsdAuthorCanSeeRequest"]) -> typing.Union[MetaOapg.properties.jsdAuthorCanSeeRequest, schemas.Unset]: ...
    
    @typing.overload
    def get_item_oapg(self, name: typing_extensions.Literal["jsdPublic"]) -> typing.Union[MetaOapg.properties.jsdPublic, schemas.Unset]: ...
    ...
    @typing.overload
    def get_item_oapg(self, name: typing_extensions.Literal["renderedBody"]) -> typing.Union[MetaOapg.properties.renderedBody, schemas.Unset]: ...
    ...
    def __new__(
        ...
        *args: typing.Union[dict, frozendict.frozendict, ],
        ...
        body: typing.Union[MetaOapg.properties.body, dict, frozendict.frozendict, str, date, datetime, uuid.UUID, int, float, decimal.Decimal, bool, None, list, tuple, bytes, io.FileIO, io.BufferedReader, schemas.Unset] = schemas.unset,
        created: typing.Union[MetaOapg.properties.created, str, datetime, schemas.Unset] = schemas.unset,
        id: typing.Union[MetaOapg.properties.id, str, schemas.Unset] = schemas.unset,
        jsdAuthorCanSeeRequest: typing.Union[MetaOapg.properties.jsdAuthorCanSeeRequest, bool, schemas.Unset] = schemas.unset,
        jsdPublic: typing.Union[MetaOapg.properties.jsdPublic, bool, schemas.Unset] = schemas.unset,
        properties: typing.Union[MetaOapg.properties.properties, list, tuple, schemas.Unset] = schemas.unset,
        renderedBody: typing.Union[MetaOapg.properties.renderedBody, str, schemas.Unset] = schemas.unset,
