...
class Context(
    ...
    def __getitem__(self, name: typing.Union[typing_extensions.Literal["id", "name", "scope", ], str]):
    ...
    def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["id", "name", "scope", ], str]):
