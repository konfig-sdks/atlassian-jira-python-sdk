...
class UpdateUserToGroupBean(
    ...
    def __getitem__(self, name: typing.Union[typing_extensions.Literal["accountId"], typing_extensions.Literal["name"], str, ]):
    ...
    def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["accountId"], typing_extensions.Literal["name"], str, ]):
