...
class PageOfChangelogs(
        ...
        class properties:
            ...
            class histories(
                ...
                class MetaOapg:
                    ...
                    @staticmethod
                    def items() -> typing.Type['Changelog']:
                        return Changelog
            
                def __new__(
                    cls,
                    arg: typing.Union[typing.Tuple['Changelog'], typing.List['Changelog']],
                ...
                def __getitem__(self, i: int) -> 'Changelog':
    ...
    @typing.overload
    def __getitem__(self, name: typing_extensions.Literal["histories"]) -> MetaOapg.properties.histories: ...
    ...
    def __getitem__(self, name: typing.Union[typing_extensions.Literal["histories", "maxResults", "startAt", "total", ], str]):
        # dict_instance[name] accessor
        return super().__getitem__(name)
    
    
    @typing.overload
    def get_item_oapg(self, name: typing_extensions.Literal["histories"]) -> typing.Union[MetaOapg.properties.histories, schemas.Unset]: ...
    ...
    def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["histories", "maxResults", "startAt", "total", ], str]):
    ...
    def __new__(
        ...
        *args: typing.Union[dict, frozendict.frozendict, ],
        histories: typing.Union[MetaOapg.properties.histories, list, tuple, schemas.Unset] = schemas.unset,
