...
class PermissionHolder(
    ...
    def __getitem__(self, name: typing.Union[typing_extensions.Literal["type", "expand", "parameter", "value", ], str]):
    ...
    def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["type", "expand", "parameter", "value", ], str]):
