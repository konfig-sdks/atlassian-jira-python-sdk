...
class ReorderIssueResolutionsRequest(
    ...
    class MetaOapg:
        ...
        class properties:
            ...
            @staticmethod
            def ids() -> typing.Type['ReorderIssueResolutionsRequestIds']:
                return ReorderIssueResolutionsRequestIds
    ...
    @typing.overload
    def __getitem__(self, name: typing_extensions.Literal["ids"]) -> 'ReorderIssueResolutionsRequestIds': ...
    ...
    def __getitem__(self, name: typing.Union[typing_extensions.Literal["ids", "after", "position", ], str]):
        # dict_instance[name] accessor
        return super().__getitem__(name)
    
    
    @typing.overload
    def get_item_oapg(self, name: typing_extensions.Literal["ids"]) -> 'ReorderIssueResolutionsRequestIds': ...
    ...
    def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["ids", "after", "position", ], str]):
