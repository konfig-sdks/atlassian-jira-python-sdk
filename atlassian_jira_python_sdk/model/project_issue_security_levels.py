...
class ProjectIssueSecurityLevels(
    ...
    levels: MetaOapg.properties.levels
    ...
    @typing.overload
    def get_item_oapg(self, name: typing_extensions.Literal["levels"]) -> MetaOapg.properties.levels: ...
    ...
    def __new__(
        ...
        *args: typing.Union[dict, frozendict.frozendict, ],
        levels: typing.Union[MetaOapg.properties.levels, list, tuple, ],
        _configuration: typing.Optional[schemas.Configuration] = None,
