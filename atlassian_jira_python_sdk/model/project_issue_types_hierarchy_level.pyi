...
class ProjectIssueTypesHierarchyLevel(
        ...
        class properties:
            ...
            class issueTypes(
                ...
                class MetaOapg:
                    ...
                    @staticmethod
                    def items() -> typing.Type['IssueTypeInfo']:
                        return IssueTypeInfo
            
                def __new__(
                    cls,
                    arg: typing.Union[typing.Tuple['IssueTypeInfo'], typing.List['IssueTypeInfo']],
                ...
                def __getitem__(self, i: int) -> 'IssueTypeInfo':
    ...
    def __getitem__(self, name: typing.Union[typing_extensions.Literal["entityId", "issueTypes", "level", "name", ], str]):
    ...
    def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["entityId", "issueTypes", "level", "name", ], str]):
