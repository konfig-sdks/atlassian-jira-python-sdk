 ...
 *  User record unavailable: This usually occurs due to an internal service outage. In this case, all parameters have fallback values.
    ...
    def __getitem__(self, name: typing.Union[typing_extensions.Literal["accountId", "accountType", "active", "avatarUrls", "displayName", "emailAddress", "key", "name", "self", "timeZone", ], str]):
    ...
    def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["accountId", "accountType", "active", "avatarUrls", "displayName", "emailAddress", "key", "name", "self", "timeZone", ], str]):
