...
class AddFieldBean(
    ...
    def __getitem__(self, name: typing.Union[typing_extensions.Literal["fieldId", ], str]):
    ...
    def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["fieldId", ], str]):
