...
class UiModificationIdentifiers(
    ...
    def __getitem__(self, name: typing.Union[typing_extensions.Literal["id", "self", ], str]):
    ...
    def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["id", "self", ], str]):
