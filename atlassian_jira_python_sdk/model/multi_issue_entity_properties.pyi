...
class MultiIssueEntityProperties(
        ...
        class properties:
            ...
            class issues(
                ...
                class MetaOapg:
                    ...
                    @staticmethod
                    def items() -> typing.Type['IssueEntityPropertiesForMultiUpdate']:
                        return IssueEntityPropertiesForMultiUpdate
            
                def __new__(
                    cls,
                    arg: typing.Union[typing.Tuple['IssueEntityPropertiesForMultiUpdate'], typing.List['IssueEntityPropertiesForMultiUpdate']],
                ...
                def __getitem__(self, i: int) -> 'IssueEntityPropertiesForMultiUpdate':
    ...
    def __getitem__(self, name: typing.Union[typing_extensions.Literal["issues", ], str]):
    ...
    def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["issues", ], str]):
