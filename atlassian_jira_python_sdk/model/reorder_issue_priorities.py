...
class ReorderIssuePriorities(
    ...
    class MetaOapg:
        ...
        class properties:
            ...
            @staticmethod
            def ids() -> typing.Type['ReorderIssuePrioritiesIds']:
                return ReorderIssuePrioritiesIds
    ...
    @typing.overload
    def __getitem__(self, name: typing_extensions.Literal["ids"]) -> 'ReorderIssuePrioritiesIds': ...
    ...
    @typing.overload
    def get_item_oapg(self, name: typing_extensions.Literal["ids"]) -> 'ReorderIssuePrioritiesIds': ...
