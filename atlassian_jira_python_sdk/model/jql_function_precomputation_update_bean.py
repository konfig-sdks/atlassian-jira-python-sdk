...
class JqlFunctionPrecomputationUpdateBean(
    ...
    def __getitem__(self, name: typing.Union[typing_extensions.Literal["id", "error", "value", ], str]):
    ...
    def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["id", "error", "value", ], str]):
