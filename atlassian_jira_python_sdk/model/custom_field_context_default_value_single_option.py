...
class CustomFieldContextDefaultValueSingleOption(
    ...
    def __getitem__(self, name: typing.Union[typing_extensions.Literal["contextId", "optionId", "type", ], str]):
    ...
    def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["contextId", "optionId", "type", ], str]):
