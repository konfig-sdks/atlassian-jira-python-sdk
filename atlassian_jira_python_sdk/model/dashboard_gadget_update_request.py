...
class DashboardGadgetUpdateRequest(
    ...
    def __getitem__(self, name: typing.Union[typing_extensions.Literal["title", "color", "position", ], str]):
    ...
    def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["title", "color", "position", ], str]):
