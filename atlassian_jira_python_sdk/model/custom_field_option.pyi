...
class CustomFieldOption(
    ...
    def __getitem__(self, name: typing.Union[typing_extensions.Literal["self", "value", ], str]):
    ...
    def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["self", "value", ], str]):
