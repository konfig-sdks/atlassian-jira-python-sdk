...
class CustomFieldOptionUpdate(
    ...
    def __getitem__(self, name: typing.Union[typing_extensions.Literal["id", "disabled", "value", ], str]):
    ...
    def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["id", "disabled", "value", ], str]):
