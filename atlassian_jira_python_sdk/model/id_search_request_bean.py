...
class IdSearchRequestBean(
    ...
    def __getitem__(self, name: typing.Union[typing_extensions.Literal["jql", "maxResults", "nextPageToken", ], str]):
    ...
    def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["jql", "maxResults", "nextPageToken", ], str]):
