...
class IssueTypeInfo(
    ...
    def __getitem__(self, name: typing.Union[typing_extensions.Literal["avatarId", "id", "name", ], str]):
    ...
    def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["avatarId", "id", "name", ], str]):
