...
class WorkflowUpdateResponse(
    ...
    def __getitem__(self, name: typing.Union[typing_extensions.Literal["statuses", "taskId", "workflows", ], str]):
    ...
    def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["statuses", "taskId", "workflows", ], str]):
